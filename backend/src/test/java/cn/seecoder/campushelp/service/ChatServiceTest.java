...
class ChatServiceTest {
    ...
    void sendMessage_shouldPersistAndUpdateSnapshot() {
        ...
        Message msg = chatService.sendMessage(conv.getConversationId(), outsiderId, "Hello publisher!");
    ...
    void sendMessage_shouldTrimContent() {
        ConversationResponse conv = chatService.getOrCreateConversation(outsiderId, openDemandId, publisherId);
        Message msg = chatService.sendMessage(conv.getConversationId(), outsiderId, "  trimmed  ");
    ...
    void sendMessage_nonParticipant_shouldThrow() {
        ...
        BusinessException ex = assertThrows(BusinessException.class,
                () -> chatService.sendMessage(conv.getConversationId(), acceptorId, "Hi"));
        assertEquals(403, ex.getCode());
    }
    ...
    void getMessages_shouldReturnOrderedAndMarkRead() {
        ...
        chatService.sendMessage(conv.getConversationId(), outsiderId, "First");
        chatService.sendMessage(conv.getConversationId(), publisherId, "Second");
        chatService.sendMessage(conv.getConversationId(), outsiderId, "Third");
    ...
    void listConversations_shouldReturnWithUnreadCounts() {
        ...
        chatService.sendMessage(conv1.getConversationId(), outsiderId, "Hi");
        ...
        chatService.sendMessage(conv2.getConversationId(), publisherId, "Ready?");
    ...
    void unreadCount_shouldAggregate() {
        ConversationResponse conv1 = chatService.getOrCreateConversation(outsiderId, openDemandId, publisherId);
        chatService.sendMessage(conv1.getConversationId(), outsiderId, "Msg 1");
        chatService.sendMessage(conv1.getConversationId(), outsiderId, "Msg 2");

        ConversationResponse conv2 = chatService.getOrCreateConversation(acceptorId, acceptedDemandId, publisherId);
        chatService.sendMessage(conv2.getConversationId(), acceptorId, "Msg 3");
    ...
    void unreadCount_decreasesAfterReading() {
        ConversationResponse conv = chatService.getOrCreateConversation(outsiderId, openDemandId, publisherId);
        chatService.sendMessage(conv.getConversationId(), outsiderId, "Hello");
